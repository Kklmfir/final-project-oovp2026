...
INSERT INTO Category (Category_ID, Category_Name, Description) VALUES
    ('CAT001', 'Novels', 'Books that contain fictional stories.'),
    ('CAT002', 'Self Improvement', 'Books on personal growth and motivation.'),
    ('CAT003', 'History', 'Books that cover historical events and figures.'),
    ('CAT004', 'Religion', 'Books that explore religious beliefs and practices.'),
    ('CAT005', 'Fantasy', 'Books featuring imaginary worlds and magic.'),
    ('CAT006', 'Psychology', 'Books examining the human mind and behavior.'),
    ('CAT007', 'Technology', 'Books on technological advancements.'),
    ('CAT008', 'Romance', 'Books exploring themes of love and relationships.'),
    ('CAT009', 'Education', 'Books providing knowledge for educational purposes.'),
    ('CAT010', 'Business', 'Books covering business management and economics.');
...
INSERT INTO Author_Book (Author_Book_ID, Author_Book_Name, Author_Book_Contact) VALUES
    ...
    ('AUTHB008', 'Dewi Lestari 2', 'dee2@truedee.com'),
...
INSERT INTO Book (Book_ID, Book_Title, Book_Author_ID, Book_Category_ID, Book_Publisher_ID, Book_Year, ISBN, Book_Stock, Book_Status) VALUES
    ('BK001', 'Laskar Pelangi', 'AUTHB001', 'CAT001', 'PUB001', 2005, '9789793062792', 6, 1), -- Available
    ('BK002', 'Sang Pemimpi', 'AUTHB001', 'CAT001', 'PUB001', 2006, '9789791227209', 5, 1), -- Available
    ('BK003', 'Bumi Manusia', 'AUTHB002', 'CAT003', 'PUB009', 1980, '9789799731234', 8, 1), -- Available
    ('BK004', 'Anak Semua Bangsa', 'AUTHB002', 'CAT003', 'PUB009', 1981, '9789799731241', 6, 0), -- Borrowed
    ('BK005', 'Negeri 5 Menara', 'AUTHB003', 'CAT009', 'PUB002', 2009, '9789791227216', 4, 1), -- Available
    ('BK006', 'Ranah 3 Warna', 'AUTHB003', 'CAT009', 'PUB002', 2011, '9789792248616', 3, 0), -- Borrowed
    ('BK007', 'Ayat-Ayat Cinta', 'AUTHB004', 'CAT004', 'PUB003', 2004, '9789793210605', 7, 1), -- Available
    ('BK008', 'Ketika Cinta Bertasbih', 'AUTHB004', 'CAT004', 'PUB003', 2007, '9789791102162', 5, 0), -- Borrowed
    ('BK009', 'Bumi', 'AUTHB005', 'CAT005', 'PUB004', 2014, '9786020332956', 5, 1), -- Available
    ('BK010', 'Bulan', 'AUTHB005', 'CAT005', 'PUB004', 2015, '9786020351179', 3, 1), -- Available
    ('BK011', 'Supernova', 'AUTHB006', 'CAT005', 'PUB005', 2001, '9789799625700', 6, 1), -- Available
    ('BK012', 'Perahu Kertas', 'AUTHB008', 'CAT008', 'PUB002', 2009, '9789791227223', 4, 1), -- Available
    ('BK013', 'Atomic Habits', 'AUTHB009', 'CAT002', 'PUB002', 2019, '9786020633176', 4, 1), -- Available
    ('BK014', 'Filosofi Teras', 'AUTHB010', 'CAT006', 'PUB006', 2018, '9786024125189', 6, 1), -- Available
    ('BK015', 'Belajar Dasar Python', 'AUTHB007', 'CAT007', 'PUB010', 2023, '9786231234567', 2, 0); -- Borrowed
...
INSERT INTO Member_Type (Member_Type_ID, Type_Name, Loan_Days, Loan_Limit, Fine_Per_Day) VALUES
    ...
    */
    ...
    -- GUESTS
    ('GST001', 'Keefi Almer', 7, 'GST001', 1.00),
    ('GST002', 'Alfairaz Putra', 7, 'GST001', 1.00),
    ('GST003', 'Azizah Putri', 7, 'GST001', 1.00),
    ('GST004', 'Yesi N. Fitri', 7, 'GST001', 1.00),
    ('GST005', 'Fattah Rohman', 7, 'GST001', 1.00);

-- Member
INSERT INTO Member (Member_ID, Member_Name, Register_Date, Member_Type_ID, Identifier, Email, Phone) VALUES
    -- STUDENTS
    ('STU2026001', 'Keefi Almer Firdaus', '2026-04-01 08:15:00', 'STD001', 'Student', 'keefi.firdaus@student.president.ac.id', 081381110001),
    ('STU2026002', 'Alfairaz Putra Anantar', '2026-04-01 08:30:00', 'STD002', 'Student', 'alfairaz.anantar@student.president.ac.id', 081381110002),
    ('STU2026003', 'Azizah Putri Susanto', '2026-04-01 08:45:00', 'STD003', 'Student', 'azizah.susanto@student.president.ac.id', 081381110003),
    ('STU2026004', 'Yesi Nurfitriyani', '2026-04-01 09:00:00', 'STD004', 'Student', 'yesi.fitriyani@student.president.ac.id', 081381110004),
    ('STU2026005', 'M Fattah Fadli Rohman Putra', '2026-04-01 09:15:00', 'STD005', 'Student', 'fattah.putra@student.president.ac.id', 081381110005),
    -- LECTURERS
    ('LEC2026001', 'Dr. Keefi A. Firdaus', '2026-04-02 10:00:00', 'LEC001', 'Lecturer', 'keefi.firdaus@president.ac.id', 081381110011),
    ('LEC2026002', 'Prof. Alfairaz P. Anantar', '2026-04-02 10:20:00', 'LEC002', 'Lecturer', 'alfairaz.anantar@president.ac.id', 081381110012),
    ('LEC2026003', 'Dr. Azizah P. Susanto', '2026-04-02 10:40:00', 'LEC003', 'Lecturer', 'azizah.susanto@president.ac.id', 081381110013),
    ('LEC2026004', 'Dr. Yesi N. Fitriyani', '2026-04-02 11:00:00', 'LEC004', 'Lecturer', 'yesi.fitriyani@president.ac.id', 081381110014),
    ('LEC2026005', 'Prof. Fattah R. Rohman', '2026-04-02 11:20:00', 'LEC005', 'Lecturer', 'fattah.rohman@president.ac.id', 081381110015),
    -- GUESTS
    ('GST2026001', 'Keefi Almer', '2026-04-03 11:40:00', 'GST001', 'Guest', 'keefi.almer@outlook.com', 081381110021),
    ('GST2026002', 'Alfairaz Putra', '2026-04-03 12:20:00', 'GST002', 'Guest', 'alfairaz.putra@gmail.com', 081381110022),
    ('GST2026003', 'Azizah Putri', '2026-04-03 12:00:00', 'GST003', 'Guest', 'azizah.putri@outlook.com', 081381110023),
    ('GST2026004', 'Yesi N. Fitri', '2026-04-03 11:00:00', 'GST004', 'Guest', 'yesi.fitri@gmail.com', 081381110024),
    ('GST2026005', 'Fattah Rohman', '2026-04-03 11:20:00', 'GST005', 'Guest', 'fattah.rohman@yahoo.com', 081381110025);
...
-- Audio_Book (FIX: ISBN duplikat diperbaiki)
INSERT INTO Audio_Book (Audio_Book_ID, Audio_Book_Title, Audio_Book_Author_ID, Audio_Book_Category_ID, Audio_Book_Publisher_ID, Audio_Book_Year, ISBN, Audio_Book_Duration, Audio_Book_Format, Audio_Book_Status) VALUES
    ('ABK001', 'Sad Miaw Story', 'AUTHAB001', 'CAT001', 'PUB001', 2020, '9789793062800', 3600, 'MP3', 1), -- Available
    ('ABK002', 'The Best Part of Meong', 'AUTHAB002', 'CAT002', 'PUB002', 2021, '9789791227230', 5400, 'AAC', 0), -- Borrowed
    ('ABK003', 'How to Call Chicken', 'AUTHAB003', 'CAT003', 'PUB003', 2022, '9789799731258', 4200, 'WAV', 1), -- Available
    ('ABK004', 'The Adventures of Icikiwir', 'AUTHAB004', 'CAT004', 'PUB004', 2023, '9789799731265', 4800, 'MP3', 1), -- Available
    ('ABK005', 'The Secrets of Kicau Mania', 'AUTHAB005', 'CAT005', 'PUB005', 2024, '9789791227247', 3000, 'AAC', 0); -- Borrowed
...
-- KEEP FOREIGN KEY CHECKS ENABLE BUT TURN OF THE BUTTON "Enable foreign key checks" BEFORE APPLYING THE SQL
